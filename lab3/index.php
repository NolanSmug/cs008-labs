...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Lab Three - Carbon Dioxide Emissions</title>
        ...
        <main>
            ...
            <section>
                ...
                <figure style="text-align:left;">
                    <img src="image/ghg_model.png" style="max-width: 30%;"  alt="Greenhouse gas model.">
                    <figcaption>Visual Representation of Greenhouse Gasses
                        <cite style="font-size: xx-small;">Photo by Newsela team</cite>
                    </figcaption>
                </figure>
            </section>
            ...
            <section>
                ...
                <ol>
                    <li>Carbon Dioxide - 79%</li>
                    <li>Methane - 11%</li>
                    <li>Nitrous Oxide - 7%</li>
                    <li>Flourinated Gases - 3%</li>
                </ol>   
                <cite> <a href="https://www.epa.gov/report-environment/greenhouse-gases">Greenhouse Gases</a></cite> 
            </section>
